...
contract DeployMATE is Script {
    ...
    function run() external returns (MATEStableCoin, MATEEngine) {
        HelperConfig config = new HelperConfig();
        (address wETHUSDPriceFeed, address wBTCUSDPriceFeed, address wETH, address wBTC, uint256 deployerAccount) =
        ...
        vm.stopBroadcast();
        return (mateContract, engineContract);
    }
}
